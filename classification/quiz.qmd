...
A Random Forest Regressor outputs continuous values, whereas a Random Forest Classifier outputs discrete categories.
:::
...
:::{.choice}
A Random Forest Classifier outputs probability distributions.
:::
