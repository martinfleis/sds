...
You will work with the same data you already used in the chapter on [spatial autocorrelation](../autocorrelation/hands_on.qmd) - the results of the second round of the presidential elections in Czechia in 2023, between Petr Pavel and Andrej Babiš, on a level of municipalities. You can read the election data directly from the chapter 5 location.

```{python}
elections = gpd.read_file(
    "../autocorrelation/data/cz_elections_2023.gpkg"
)
