...
![Illustration of kernel by Fotheringham et al. (2002, p.44)](figures/bandwidth.png)
...
- geographically weighted regression
    - single model may be too restrictive to capture geographical diversity
    ...
    - evaluation
        - Betas per region, p-value per region
    - multiscale gwr
        - each variable has its own bandwidth
    - either is computationally expensive and scale linearly - bad. useful only for smaller data