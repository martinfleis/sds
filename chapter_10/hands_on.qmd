...
::: {.callout-caution}
# Still in works
This notebook currently requires development versions of `mgwr` and `spglm` packages specified in the [environment file](../environment.yml).
:::
...
Illustrations of kernels. Reproduced from Fotheringham et al. [-@Fotheringham_et_al_2002_book, pp.44-45]
:::
...
The details of the implications of the choices are beyond the scope of this lesson but are discussed in-depth by @Fotheringham_et_al_2002_book.
...
If you'd like to learn the details of GWR, _Geographically Weighted Regression_ by @Fotheringham_et_al_2002_book is a good start.
:::
