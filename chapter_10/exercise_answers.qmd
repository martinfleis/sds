...
Go back to the [Does it correlate?](../chapter_05/exercise.qmd) and load the dataset to your Jupyter Notebook. Do not filter for Glasgow this time, use the whole dataset.
