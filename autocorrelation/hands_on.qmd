...
plt.text(2.3, 2.7, "High-high", fontsize=10)    # <3>
plt.text(2.3, -2.7, "High-low", fontsize=10)    # <3>
plt.text(-4.4, 2.7, "Low-high", fontsize=10)    # <3>
plt.text(-4.4, -2.7, "Low-low", fontsize=10);   # <3>
```
...
3. Annotate different quadrants.
