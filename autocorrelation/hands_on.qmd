...
# Static plots
You can also create a static using another PySAL package called `splot` but note that
this function will likely move directly to the `esda.Moran_Local` class soon.
