...
The main tool dealing with the setup of the coding environment used in this course is [Pixi](https://pixi.sh). Go to Pixi weibsite, and follow the [installation instructions](https://pixi.sh/latest/#installation) to install it on your machines.

### Get the template repository and install the environment

There is a template repository you should be using during this course. The repository contains
the definition of the environment and a placeholder structure for your work.

1. Go to [https://github.com/martinfleis/sds4sg](https://github.com/martinfleis/sds4sg) and either download or clone the repository to a location on your machine where you'd like to store the files for this course.
2. Use Command Line or Terminal to navigate to the folder.
