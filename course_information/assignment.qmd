...
[^1]: Based on chapters 1 ([Introduction](../introduction/hands_on.qmd)) - 3 ([Spatial data](../geographic_data/hands_on.qmd)).
[^2]: Based on chapters 4 ([Spatial weights](../spatial_graphs/hands_on.qmd)) - 6 ([Point patterns](../point_patterns/hands_on.qmd)).
[^3]: Based on chapters 7 ([Clustering](../clustering/hands_on.qmd)) - 11 ([Machine learning](../classification/hands_on.qmd)).
