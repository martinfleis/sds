...
[this link](https://martinfleischmann.net/sds/chapter_03/data/geoboundaries_cgaz.gpkg)
and saving the file
...
1. Download the file by right-clicking on
[this link](https://martinfleischmann.net/sds/chapter_03/data/catalonia.gpkg)
and saving the file
2. Place the file in the same folder as the notebook where you intend to read it
3. Replace the code in the cell above with:
