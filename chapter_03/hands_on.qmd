...
3. Specify the provider. Nominatim is free, using the data from OpenStreetMap.
4. Nominatim requires the identification of a user using the service. That can be practically any string.
