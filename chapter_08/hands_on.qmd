...
```py
pop_url = "https://martinfleischmann.net/sds/chapter_08/data/GHS_POP_E2030_GLOBE_R2023A_54009_100_V1_0_R4_C20.zip"
```
:::
...
```py
fua_url = "https://martinfleischmann.net/sds/chapter_08/data/GHS_FUA_UCDB2015_GLOBE_R2019A_54009_1K_V1_0.zip"
```
:::
...
```py
volume_url = "https://martinfleischmann.net/sds/chapter_08/data/GHS_BUILT_V_E2030_GLOBE_R2023A_54009_100_V1_0_R4_C20.zip"
```
:::
...
bud_cube = xr.concat(
    ...
    dim=pd.Index(["density", "population", "built-up volume"], name="measurement")
)
bud_cube
```
