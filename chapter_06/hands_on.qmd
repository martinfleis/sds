...
The intuition behind the statistic can be built based on the plot of the $G$ values per each distance threshold, comparing the observed results with those based on simulated random point pattern.
