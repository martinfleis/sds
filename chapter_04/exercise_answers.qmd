...
The plot above is done using subplots. You will see more of those, so check the [documentation](https://matplotlib.org/stable/users/explain/axes/axes_intro.html) on how those work.
