...
:::::{.question}
**What is the difference between Queen, and Rook, and Bishop contiguity?**
...
:::{.choice .correct-choice}
Queen considers neighbors that share at least a vertex, Rook considers only shared edges, Bishop considers shared vertices only that are not part of shared edges.
:::
