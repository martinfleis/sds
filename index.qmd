...
The course is provided by Charles University as a standalone micro-credentials certification and is taught __online__ every August. The
course is open to anyone.

<!-- ::: {.callout-important}
# Course registration for 2024 is now open

The course will happen between 12.8. - 16.8. with 6 teaching hours a day. The fee for 2024 is 15,000 CZK (approximately €600).
Registration is open until August 9.

Please enroll via the [university portal](https://is.cuni.cz/studium/eng/prijimacky/index.php?do=detail_kurz_mc&cid=10752).
...
[The material is planned for 12 weeks, with one session per week.]{.content-visible when-profile='sds4sg'}[The material is planned for 5 days with two 3-hour sessions per day. ]{.content-visible when-profile='micro'} Each session
