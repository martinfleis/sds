...
The course Spatial Data Science introduces data science and computational analysis
using open source tools written in the Python programming language to the curriculum of
students of geography.

The course is taught in person at Charles University in Prague under the code `MZ340R18`.
:::
...
<!-- ::: {.callout-important}
# Course registration for 2026 is now open

The first block of classes is scheduled for **May 11 - 15**, and the second block for **May 25 - 29**, each day from 16:00 to 18:00 CEST (Prague time zone). The fee for 2026 is 7,500 CZK (approximately €300). Registration is open until May 6 but the capacity is limited and filled on the first come, first served basis.

Please enroll via the [university portal](https://is.cuni.cz/studium/eng/prijimacky/index.php?do=detail_kurz_mc&cid=12557).
...
::: -->
::: {.callout-important}
# Course registration for May 2026 is now closed
...
::: {.content-visible when-profile='micro'}
A basic understanding of Python and understanding of data analysis using `pandas` is required as it is not covered.
:::
...
assignment in the form of a computational essay followed by an oral defence. See the
