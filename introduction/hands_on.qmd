...
Miniforge Prompt application installed. It will look like this:

![Terminal on macOS](../assets/figures/introduction/terminal.png)

Terminal (and Miniforge Prompt or Command line, but we will refer to all as the terminal for simplicity) is
...
the folder. For that, you can use the `cd` command, which stands for [c]{.accent}urrent
[d]{.accent}irectory.
...
![Output of the `ls` command.](../assets/figures/introduction/ls.png)
...
![Output of the `ls -l` command.](../assets/figures/introduction/ls-l.png)
...
section, you have used `mamba` with parameters specifying that you want to use it
...
point later. You can check more in the [documentation of mamba](https://mamba.readthedocs.io/).

### Other options

Mamba is not the only way of setting up a Python environment. If you don't want to install anything on your
...
with multiple notebooks and switch between your Python environments created with Mamba.
...
![Jupyter Lab interface](../assets/figures/introduction/lab.png)
...
![Jupyter Notebook cell](../assets/figures/introduction/cell.png)
