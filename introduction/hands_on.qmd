...
First, navigate to the your folder that contains the Pixi environment (use `ls` command 
followed by the path. You can also drag-and-drop the folder to the shell). 
...
way but if you prefer more explicit material, have a look at the _[Basic programming concepts](https://pythongis.org/part1/chapter-02/index.html)_ chapter of the _[Introduction to Python for Geographic Data Analysis](https://pythongis.org/index.html) book by H. Tenkanen, V. Heikinheimo and  D. Whipp.
:::
